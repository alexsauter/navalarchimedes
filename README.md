...
### Subflow of short range radar

As an example of a radar that can be used, a HLK-LD2450 chip was tested and can be implemented, her shown from the side facing the antenna.

<p align="center"><img src="https://raw.githubusercontent.com/alexsauter/navalarchimedes/main/figs/RadarFront.jpg" width="70%"></p>

The chip is a 24 GHz radar reporting the position of up to three targets simultaneously, with a range of up to 6.5 meters. Each target is positions in a 2D-plane in units of millimeters and with a relativ speed in centimeters per second.<br>
...
<p align="center"><img src="https://raw.githubusercontent.com/alexsauter/navalarchimedes/main/figs/RadarNode.png" width="70%"></p>

The output of the radar-node looks like the following, here with only one proper detection.

<p align="center"><img src="https://raw.githubusercontent.com/alexsauter/navalarchimedes/main/figs/RadarNodeOutput.png" width="50%"></p>
